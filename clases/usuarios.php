...
//			}
	...
	public function getdatosUsuarios(){
		...
		if($result){
			$this->datosUsuario($result["nombres"], $result["apellidos"], $result["regiones_id"], $result["direccion"], $result["genero"], $result["dia_nac"],$result["mes_nac"],$result["agno_nac"], $result["descripcion"], $result["website"], $result["facebook"], $result["twitter"], $result["telefonos"]);
			$this->id = $result["id"];
		}else {
			return false;
		}
	 ...
	 * =========--- Setters ---========= *
	 * * * * * * * * * * * * * * * * * * */
	public function datosUsuario($nombres, $apellidos, $regiones_id, $direccion, $genero, $dia_nac, $mes_nac, $agno_nac,$telefonos,$descripcion=NULL,$website=NULL, $facebook=NULL, $twitter = NULL) {
		$this->nuevoUsuario ();
