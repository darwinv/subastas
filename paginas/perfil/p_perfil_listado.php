				...
				<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 text-right">					
					<div class="navbar-form marR10 marL10" role="search">
						...
						<div class="input-group" style="">
							...
							<input style="margin-left: -10px; border: #ccc 1px solid; border-left:1px solid #FFF; width: 180px; type="text" class="form-control-header " placeholder="Buscar" id="txtBusqueda" name="txtBusqueda">
                		</div>
                    ...
                    <?php
                        if(!empty($recursos)):
                            ...
                            <div class="alert alert-success t30">
                                ...
                                <p>A&uacute;n no contamos con publicaciones de est&eacute; usuario.</p><br>
                            </div>
                        <?php endif;?>
		</div>
	</div>
