...
<form id="usr-reg-form" action="fcn/f_usuarios.php" method="post" class="form-inline" ng-model="form-registro">
	<section class="form-apdp" ng-app="registrarAp" ng-controller="RegistrarController">
		<div class="row">			
			...
			<div class="hidden-xs col-sm-12""><br></div>
			<div class="col-xs-12 ">
				<span class="marL10"><i class="fa fa-envelope"></i> Teléfonos</span>
			</div>			
			<div class=" form-group col-xs-12 col-sm-12 col-md-12 col-lg-12 input">
				<input type="text" class="form-input noseleccionable" id="telefonos" name="telefonos" placeholder=" Ingresa tu números telefonicos..." oncontextmenu="return false"/>
			</div>			
			<div class="hidden-xs col-sm-12""><br></div>
			<div class="col-xs-12 ">
			...
			<div class="hidden-xs col-sm-12"><br></div>
			<div class="col-xs-12">
				<input type="checkbox" ng-model="acepto"> Acepto los t&eacute;rminos del sitio &nbsp;&nbsp;</input>
